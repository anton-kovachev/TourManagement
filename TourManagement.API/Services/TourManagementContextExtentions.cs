...
{
    public static class TourManagementContextExtentions
    {
        public static void EnsureSeedDatabase(this TourManagementContext context) 
        {
            ...
            var managers = new List<Manager>()
            {
                ...
                new Manager()
                {
                    ManagerId = new Guid("57525bb1-395d-4958-8711-25e78cf634a0"),
                    Name = "Alice",
                    CreatedBy = "system",
                    CreatedOn = DateTime.UtcNow
                }
            ...
            var tours = new List<Tour>()
            {
                ...
                new Tour()
                {
                    //TourId = new Guid("f67ba678-b6e0-4307-afd9-e804c23b3cs3"),
                    BandId = new Guid("83b126b9-d7bf-4f50-96dc-860884155f8b"),
                    ManagerId = new Guid("57525bb1-395d-4958-8711-25e78cf634a0"),
                    Title = "Nick's European Tour",
                    Description = "Nick Cave and The Bad Seeds have announced an 4-months European tour kicking off in the Croatia at Zagreb’s Arena on 24th September.",
                    StartDate = new DateTimeOffset(2018,9,24,0,0,0, new TimeSpan()),
                    EndDate = new DateTimeOffset(2019,1,20,0,0,0, new TimeSpan()),
                    EstimatedProfits = 1150000,
                    CreatedBy = "system",
                    CreatedOn = DateTime.UtcNow,
                    Shows = new List<Show>() 
                    {
                        new Show() {
                            ...
                            City = "Zagreb",
                            Country = "Croatia",
                            Date = new DateTimeOffset(2018,9,24,0,0,0, new TimeSpan()),
                            CreatedBy = "system",
                            CreatedOn = DateTime.UtcNow
                        },
                        new Show() {
                            Venue = "Arena Belgrade",
                            City = "Belgrade",
                            Country = "Serbia",
                            Date = new DateTimeOffset(2018,10,25,0,0,0, new TimeSpan()),
                            CreatedBy = "system",
                            CreatedOn = DateTime.UtcNow
                        }
                    }
