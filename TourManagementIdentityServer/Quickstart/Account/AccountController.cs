...
using TourManagementIdentityServer.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerViewModel, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddClaimAsync(applicationUser, new Claim(JwtClaimTypes.Role, "Admin"));
                    }
                    
                    _logger.LogInformation("User Createed");
